...
embeddings: 32,916 chord vectors (32-dim), each keyed by a 12-slot pitch-class vector
...
assets/         favicon
data/
  data.json     per-chord metadata (pitch-class vector, size, frequency, tonic weight)
...
1. Push this folder to a GitHub repo (e.g. as a subfolder like `chord-embeddings/` in your
